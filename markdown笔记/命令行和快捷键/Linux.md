...
<img src="C:\Users\admin\Desktop\practicing\图片笔记\Python\虚拟机软件.jpg" style="zoom: 33%;" />
...
<img src="C:\Users\admin\Desktop\practicing\图片笔记\Python\Linux主要目录.jpg" style="zoom: 25%;" />
...
<img src="C:\Users\admin\Desktop\practicing\图片笔记\Python\ssh.png" style="zoom:33%;" />
...
<img src="C:\Users\admin\Desktop\practicing\图片笔记\Python\FileZilla.png" style="zoom:50%;" />
...
<img src="C:\Users\admin\Desktop\practicing\图片笔记\Python\ls -a命令.png" style="zoom:33%;" />

<img src="C:\Users\admin\Desktop\practicing\图片笔记\Python\ls -l命令.png" alt="ls -l命令" style="zoom: 33%;" />
...
- 离线安装(```deb```文件格式安装）
  - deb文件格式是Ubuntu的安装包格式，可以使用```dpkg```命令进行软件的安装和卸载。```-i```离线安装deb安装包，
    - ```cd 安装包目录``` - ```sudo dpkg -i mNetAssist-release-amd64.deb```
- 在线安装(```apt-get```方式安装)
  - 一定要联网
...
<img src="C:\Users\admin\Desktop\practicing\图片笔记\Python\镜像源.png" style="zoom: 33%;" />
